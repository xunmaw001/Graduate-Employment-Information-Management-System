		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.qiyeguimo" type="text" name="qiyeguimo" id="qiyeguimo" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div v-if="detail.qiyetupian" class="layui-input-block">
							<img id="qiyetupianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :src="detail.qiyetupian">
							<input type="hidden" :value="detail.qiyetupian" id="qiyetupian" name="qiyetupian" />
						</div>
						<div class="layui-input-block">
							<button type="button" class="layui-btn btn-theme" id="qiyetupianUpload">
						...
						<div class="layui-input-block">
							<textarea name="qiyejianjie" id="qiyejianjie">请输入企业简介</textarea>
						</div>
					</div>
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																																																																...
                																																																																// 上传图片
				var qiyetupianUpload = upload.render({
					//绑定元素
					elem: '#qiyetupianUpload',
					//上传接口
					...
					// 上传成功
						...
						if (res.code == 0) {
							...
							jquery('#qiyetupian').val(url);
							jquery('#qiyetupianImg').attr('src', url)
                            vue.detail.qiyetupian = url;
						} else {
							layer.msg(res.msg, {
								time: 2000,
								icon: 5
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                    					...
                                                                                                    					var qiyejianjie = tinymce.get('#qiyejianjie').getContent()
					data.qiyejianjie = qiyejianjie;
