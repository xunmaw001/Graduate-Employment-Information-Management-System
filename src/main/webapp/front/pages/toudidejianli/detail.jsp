				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>教育背景：</span>
							<span class="desc">
								{{detail.jiaoyubeijing}}
							</span>
						</div>
																								<div class="detail-item">
							<span>获奖证书：</span>
							<span class="desc">
								{{detail.huojiangzhengshu}}
							</span>
						</div>
																								<div class="detail-item">
							<span>毕业学校：</span>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('toudidejianli','面试邀请')" @click="onAcrossTap('mianshiyaoqing')" type="button" class="layui-btn">
								面试邀请
							</button>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div style="word-break:break-all" class="layui-tab-content">
								...
								<div v-html="detail.xiangxineirong"></div>
							</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`toudidejianli`);
