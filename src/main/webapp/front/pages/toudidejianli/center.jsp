					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="xuejihao" id="xuejihao" placeholder="学籍号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="xueli" id="xueli" placeholder="学历" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="qiuzhigangwei" id="qiuzhigangwei" placeholder="求职岗位" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">工作地点</label>
							<div class="layui-input-block">
								<input type="text" name="gongzuodidian" id="gongzuodidian" placeholder="工作地点" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">期望薪资</label>
							<div class="layui-input-block">
								<input type="text" name="qiwangxinzi" id="qiwangxinzi" placeholder="期望薪资" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">教育背景</label>
							<div class="layui-input-block">
								<input type="text" name="jiaoyubeijing" id="jiaoyubeijing" placeholder="教育背景" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">获奖证书</label>
							<div class="layui-input-block">
								<input type="text" name="huojiangzhengshu" id="huojiangzhengshu" placeholder="获奖证书" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
