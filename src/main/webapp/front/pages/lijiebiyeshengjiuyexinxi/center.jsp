				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<input type="text" name="ruzhidanwei" id="ruzhidanwei" placeholder="入职单位" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">入职人数</label>
							<div class="layui-input-block">
								<input type="text" name="ruzhirenshu" id="ruzhirenshu" placeholder="入职人数" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">薪酬</label>
							<div class="layui-input-block">
								<input type="text" name="xinchou" id="xinchou" placeholder="薪酬" autocomplete="off" class="layui-input">
							</div>
						</div>
