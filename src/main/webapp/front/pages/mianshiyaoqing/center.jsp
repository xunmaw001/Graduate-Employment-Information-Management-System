					...
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="shifouluyong" id="shifouluyong">
							...
							<div class="layui-input-block">
								<input type="text" name="beiyaoqingrenxingming" id="beiyaoqingrenxingming" placeholder="被邀请人姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="mianshididian" id="mianshididian" placeholder="面试地点" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">面试时间</label>
							<div class="layui-input-block">
								<input type="text" name="mianshishijian" id="mianshishijian" placeholder="面试时间" autocomplete="off" class="layui-input">
							</div>
						</div>
